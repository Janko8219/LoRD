...
module.exports = hisoka = async (hisoka, m, chatUpdate, store) => {
    ...
    thumbnail: thumb
        ...
        const replay = (teks) => {
            hisoka.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `ᴍʀ-ᴍᴅ ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ`,"body": `Follow me on instagram`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./lib/lord.jpg`),"sourceUrl": "https://instagram.com/_munavir._?igshid=YmMyMTA2M2Y="}}}, { quoted: lordofc})
        }
